...
// 1s minimum battery voltage in mv, this is 0% battery, battery specs says 2500mv but we set to 2600mv for safety
#define MIN_BATTERY_VOLTAGE     2600
// limit to set warning on low battery voltage, this is from battery readings, means 4200mv max value
#define WARN_BATTERY_VOLTAGE    3000
